...
public class WeeInput : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            var touchRay = cam.ScreenPointToRay(mouseScreenPos);
            ...
            if (Physics.Raycast(touchRay, out hit))
            {
                ...
                if (hit.collider.tag == "Draggable")
                {
                    ...
                    var mouseDelta = mouseScreenPos - prevMousePos;


                    hit.transform.position = new Vector3(2,2,2);
